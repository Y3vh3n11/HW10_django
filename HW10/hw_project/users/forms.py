...
class RegisterForm(forms.ModelForm): 
    ...
    pass1 = CharField(label='Password', required=True, widget=PasswordInput(attrs={"class": "form-control"}))
    pass2 = CharField(label='Repeat password', required=True, widget=PasswordInput(attrs={"class": "form-control"}))
