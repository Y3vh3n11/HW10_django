...
class RegisterForm(UserCreationForm):
    ...
    pass1 = CharField(required=True, widget=PasswordInput(attrs={"class": "form-control"}))
    pass2 = CharField(required=True, widget=PasswordInput(attrs={"class": "form-control"}))
